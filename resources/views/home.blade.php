        ...
        <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
            ...
            <div class="relative group flex flex-col h-full">
                ...
                <div class="relative bg-slate-900 border border-slate-800/80 rounded-2xl p-6 sm:p-8 flex flex-col justify-between text-left gap-6 flex-grow h-full">
                    ...
                    <div class="pt-2">
                        <a href="{{ url('/guia-y-tutoriales-task') }}" class="w-full inline-flex items-center justify-center px-6 py-3.5 rounded-xl bg-gradient-to-r from-neonBlue to-neonGreen text-darkBg font-outfit font-black tracking-wide shadow-lg hover:scale-105 active:scale-95 transition-all duration-300">
                            Ver Guía de Ayuda
