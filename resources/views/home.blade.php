...
<body class="bg-darkBg text-slate-100 font-jakarta min-h-screen flex flex-col justify-between overflow-x-hidden selection:bg-neonBlue selection:text-darkBg">
    ...
    <main class="relative z-10 max-w-6xl mx-auto px-6 py-16 md:py-24 text-center my-auto">
        ...
        <!-- Cards Grid -->
        <div class="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 items-stretch">
            <!-- Tutorial Card Link -->
            <div class="relative group flex flex-col h-full">
                ...
                <div class="relative bg-slate-900 border border-slate-800/80 rounded-2xl p-6 flex flex-col justify-between text-left gap-5 flex-grow h-full">
                    <div class="space-y-3">
                        ...
                        <h3 class="font-outfit font-black text-xl sm:text-2xl text-white">Guías & Tutoriales TASK</h3>
                    ...
                    <div class="pt-2">
                        <a href="{{ url('/guia-y-tutoriales-task') }}" class="w-full inline-flex items-center justify-center px-4 py-3 rounded-xl bg-gradient-to-r from-neonBlue to-neonGreen text-darkBg font-outfit font-black text-xs sm:text-sm tracking-wide shadow-lg hover:scale-105 active:scale-95 transition-all duration-300">
                            Ver Guía de Ayuda
            ...
            <div class="relative group flex flex-col h-full">
                ...
                <div class="relative bg-slate-900 border border-slate-800/80 rounded-2xl p-6 flex flex-col justify-between text-left gap-5 flex-grow h-full">
                    <div class="space-y-3">
                        ...
                        <h3 class="font-outfit font-black text-xl sm:text-2xl text-white">Últimas IA Generativas</h3>
                        <p class="text-slate-400 text-xs sm:text-sm leading-relaxed">
                            Análisis detallado de los últimos modelos de inteligencia artificial y su impacto en la productividad digital.
                        </p>
                    </div>
                    <div class="pt-2">
                        <a href="{{ route('ia.report') }}" class="w-full inline-flex items-center justify-center px-4 py-3 rounded-xl bg-gradient-to-r from-neonBlue to-neonGreen text-darkBg font-outfit font-black text-xs sm:text-sm tracking-wide shadow-lg hover:scale-105 active:scale-95 transition-all duration-300">
                            Leer Reporte
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-4 h-4 ml-2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                            </svg>
            ...
            <div class="relative group flex flex-col h-full">
                ...
                <div class="relative bg-slate-900 border border-slate-800/80 rounded-2xl p-6 flex flex-col justify-between text-left gap-5 flex-grow h-full">
                    ...
                    <div class="pt-2">
                        <a href="{{ route('apuestas') }}" class="w-full inline-flex items-center justify-center px-4 py-3 rounded-xl bg-gradient-to-r from-[#00e676] to-[#00b0ff] text-darkBg font-outfit font-black text-xs sm:text-sm tracking-wide shadow-lg hover:scale-105 active:scale-95 transition-all duration-300">
                            Jugar Simulador
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-4 h-4 ml-2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                            </svg>
