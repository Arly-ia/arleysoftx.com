        ...
        <div class="max-w-xl mx-auto space-y-6">
            ...
            <div class="relative group">
                ...
                <div class="relative bg-slate-900 border border-slate-800/80 rounded-2xl p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between text-left gap-6">
                    ...
                    <div class="w-full sm:w-auto shrink-0">
                        <a href="{{ route('ia.report') }}" class="w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 rounded-xl bg-gradient-to-r from-neonBlue to-neonGreen text-darkBg font-outfit font-black tracking-wide shadow-lg hover:scale-105 active:scale-95 transition-all duration-300">
                            Leer Reporte
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-4 h-4 ml-2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                            </svg>
